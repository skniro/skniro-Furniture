        ...
        if (entity.getCachedState().getBlock() instanceof GlassTableBlock) {
            ...
            for (int i = 0; i < 9; i++) {
                ...
                if (!stack.isEmpty()) {
                    ...
                    itemRenderer.renderItem(stack, ItemDisplayContext.FIXED, getLightLevel(entity.getWorld(), entity.getPos()), OverlayTexture.DEFAULT_UV, matrices, vertexConsumers, entity.getWorld(), 1);
                    matrices.pop();
                }
            }
