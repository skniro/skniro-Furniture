...
public class KitchenSinkBlockScreenHandler extends ScreenHandler {
    ...
    public KitchenSinkBlockScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate delegate) {
        ...
        this.addSlot(new FurnaceOutputSlot(playerInventory.player, inventory, 1, 100, 34));
