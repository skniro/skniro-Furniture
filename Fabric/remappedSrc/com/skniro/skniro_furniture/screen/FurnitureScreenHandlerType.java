...
public class FurnitureScreenHandlerType<T extends AbstractContainerMenu>{
    public static final MenuType<KitchenSinkBlockScreenHandler> Kitchen_Sink_Block_Screen_Handler =
            Registry.register(BuiltInRegistries.MENU, ResourceLocation.tryBuild(Furniture.MOD_ID, "kitchen_sink_screen_handler"),
                    new ExtendedScreenHandlerType<>(KitchenSinkBlockScreenHandler::new));
