...
public class MapleFurnitureBlocks {
    ...
    public static final Block OAK_PLANK_Glass_TRIPLE_CABINET = registerBlock("oak_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.OAK_PLANKS).nonOpaque());
    public static final Block OAK_WOOD_Glass_TRIPLE_CABINET = registerBlock("oak_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.OAK_PLANKS).nonOpaque());
    public static final Block SPRUCE_PLANK_Glass_TRIPLE_CABINET = registerBlock("spruce_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS).nonOpaque());
    public static final Block SPRUCE_WOOD_Glass_TRIPLE_CABINET = registerBlock("spruce_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS).nonOpaque());
    public static final Block BIRCH_PLANK_Glass_TRIPLE_CABINET = registerBlock("birch_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS).nonOpaque());
    public static final Block BIRCH_WOOD_Glass_TRIPLE_CABINET = registerBlock("birch_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS).nonOpaque());
    public static final Block JUNGLE_PLANK_Glass_TRIPLE_CABINET = registerBlock("jungle_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS).nonOpaque());
    public static final Block JUNGLE_WOOD_Glass_TRIPLE_CABINET = registerBlock("jungle_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS).nonOpaque());
    public static final Block ACACIA_PLANK_Glass_TRIPLE_CABINET = registerBlock("acacia_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.ACACIA_PLANKS).nonOpaque());
    public static final Block ACACIA_WOOD_Glass_TRIPLE_CABINET = registerBlock("acacia_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.ACACIA_PLANKS).nonOpaque());
    public static final Block DARK_OAK_PLANK_Glass_TRIPLE_CABINET = registerBlock("dark_oak_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.DARK_OAK_PLANKS).nonOpaque());
    public static final Block DARK_OAK_WOOD_Glass_TRIPLE_CABINET = registerBlock("dark_oak_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.DARK_OAK_PLANKS).nonOpaque());
    public static final Block MANGROVE_PLANK_Glass_TRIPLE_CABINET = registerBlock("mangrove_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.MANGROVE_PLANKS).nonOpaque());
    public static final Block MANGROVE_WOOD_Glass_TRIPLE_CABINET = registerBlock("mangrove_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.MANGROVE_PLANKS).nonOpaque());
    public static final Block CHERRY_PLANK_Glass_TRIPLE_CABINET = registerBlock("cherry_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.CHERRY_PLANKS).nonOpaque());
    public static final Block CHERRY_WOOD_Glass_TRIPLE_CABINET = registerBlock("cherry_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.CHERRY_PLANKS).nonOpaque());
    public static final Block BAMBOO_PLANK_Glass_TRIPLE_CABINET = registerBlock("bamboo_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS).nonOpaque());
    public static final Block BAMBOO_WOOD_Glass_TRIPLE_CABINET = registerBlock("bamboo_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS).nonOpaque());
    public static final Block CRIMSON_PLANK_Glass_TRIPLE_CABINET = registerBlock("crimson_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.CRIMSON_PLANKS).nonOpaque());
    public static final Block CRIMSON_WOOD_Glass_TRIPLE_CABINET = registerBlock("crimson_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.CRIMSON_PLANKS).nonOpaque());
    public static final Block WARPED_PLANK_Glass_TRIPLE_CABINET = registerBlock("warped_plank_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.WARPED_PLANKS).nonOpaque());
    public static final Block WARPED_WOOD_Glass_TRIPLE_CABINET = registerBlock("warped_wood_glass_triple_cabinet", TripleCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.WARPED_PLANKS).nonOpaque());

    //Glass four grid cabinet
    public static final Block OAK_WOOD_Glass_Four_Grid_Cabinet = registerBlock("oak_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.OAK_PLANKS).nonOpaque());
    public static final Block OAK_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("oak_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.OAK_PLANKS).nonOpaque());
    public static final Block SPRUCE_WOOD_Glass_Four_Grid_Cabinet = registerBlock("spruce_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS).nonOpaque());
    public static final Block SPRUCE_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("spruce_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS).nonOpaque());
    public static final Block BIRCH_WOOD_Glass_Four_Grid_Cabinet = registerBlock("birch_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS).nonOpaque());
    public static final Block BIRCH_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("birch_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS).nonOpaque());
    public static final Block JUNGLE_WOOD_Glass_Four_Grid_Cabinet = registerBlock("jungle_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS).nonOpaque());
    public static final Block JUNGLE_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("jungle_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS).nonOpaque());
    public static final Block ACACIA_WOOD_Glass_Four_Grid_Cabinet = registerBlock("acacia_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.ACACIA_PLANKS).nonOpaque());
    public static final Block ACACIA_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("acacia_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.ACACIA_PLANKS).nonOpaque());
    public static final Block DARK_OAK_WOOD_Glass_Four_Grid_Cabinet = registerBlock("dark_oak_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.DARK_OAK_PLANKS).nonOpaque());
    public static final Block DARK_OAK_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("dark_oak_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.DARK_OAK_PLANKS).nonOpaque());
    public static final Block MANGROVE_WOOD_Glass_Four_Grid_Cabinet = registerBlock("mangrove_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.MANGROVE_PLANKS).nonOpaque());
    public static final Block MANGROVE_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("mangrove_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.MANGROVE_PLANKS).nonOpaque());
    public static final Block CHERRY_WOOD_Glass_Four_Grid_Cabinet = registerBlock("cherry_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.CHERRY_PLANKS).nonOpaque());
    public static final Block CHERRY_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("cherry_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.CHERRY_PLANKS).nonOpaque());
    public static final Block CRIMSON_HYPHAE_Glass_Four_Grid_Cabinet = registerBlock("crimson_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.CRIMSON_PLANKS).nonOpaque());
    public static final Block CRIMSON_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("crimson_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.CRIMSON_PLANKS).nonOpaque());
    public static final Block WARPED_HYPHAE_Glass_Four_Grid_Cabinet = registerBlock("warped_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.WARPED_PLANKS).nonOpaque());
    public static final Block WARPED_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("warped_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.WARPED_PLANKS).nonOpaque());
    public static final Block BAMBOO_BLOCK_Glass_Four_Grid_Cabinet = registerBlock("bamboo_wood_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS).nonOpaque());
    public static final Block BAMBOO_PLANKS_Glass_Four_Grid_Cabinet = registerBlock("bamboo_plank_glass_four_grid_cabinet", FourGridCabinetBlock::new, AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS).nonOpaque());
