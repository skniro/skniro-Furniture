...
public class PlateBlockEntityRenderer implements BlockEntityRenderer<PlateBlockEntity, PlateBlockEntityRendererState> {
    ...
    @Override
    public void submit(PlateBlockEntityRendererState state, PoseStack matrices, SubmitNodeCollector queue, CameraRenderState cameraState) {
    ...
    @Override
    public void extractRenderState(PlateBlockEntity entity, PlateBlockEntityRendererState state, float tickProgress, Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
