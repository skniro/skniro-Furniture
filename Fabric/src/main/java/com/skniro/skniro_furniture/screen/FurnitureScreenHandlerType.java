...
public class FurnitureScreenHandlerType<T extends AbstractContainerMenu>{
    public static final MenuType<KitchenSinkBlockScreenHandler> Kitchen_Sink_Block_Screen_Handler =
            Registry.register(BuiltInRegistries.MENU, Identifier.fromNamespaceAndPath(Furniture.MOD_ID, "kitchen_sink_screen_handler"),
                    new ExtendedMenuType<>(KitchenSinkBlockScreenHandler::new, BlockPos.STREAM_CODEC));
