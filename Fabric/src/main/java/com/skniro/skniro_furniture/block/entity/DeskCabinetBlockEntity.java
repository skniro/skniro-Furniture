...
public class DeskCabinetBlockEntity extends LockableContainerBlockEntity {
    private DefaultedList<ItemStack> inventory;
    private final ViewerCountManager stateManager;

    public DeskCabinetBlockEntity(BlockPos pos, BlockState state) {
        super(FurnitureBlockEntityType.Desk_Cabinet_BLOCK_ENTITY, pos, state);
        this.inventory = DefaultedList.ofSize(27, ItemStack.EMPTY);
        this.stateManager = new ViewerCountManager() {
            protected void onContainerOpen(World world, BlockPos pos, BlockState state) {
                DeskCabinetBlockEntity.this.playSound(state, SoundEvents.BLOCK_BARREL_OPEN);
            }

            protected void onContainerClose(World world, BlockPos pos, BlockState state) {
                DeskCabinetBlockEntity.this.playSound(state, SoundEvents.BLOCK_BARREL_CLOSE);
            }
            ...
            protected boolean isPlayerViewing(PlayerEntity player) {
                if (player.currentScreenHandler instanceof GenericContainerScreenHandler) {
                    ...
                    return inventory == DeskCabinetBlockEntity.this;
                } else {
                    return false;
                }
            }
