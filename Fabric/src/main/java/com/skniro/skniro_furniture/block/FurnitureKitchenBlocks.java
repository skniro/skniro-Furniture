...
public class FurnitureKitchenBlocks {
    ...
    public static final Block Oak_Wood_Glass_Jar = registerBlock("oak_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Oak_Plank_Glass_Jar = registerBlock("oak_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    ...
    public static final Block Spruce_Plank_Glass_Jar = registerBlock("spruce_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Birch_Wood_Glass_Jar = registerBlock("birch_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Birch_Plank_Glass_Jar = registerBlock("birch_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Jungle_Wood_Glass_Jar = registerBlock("jungle_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Jungle_Plank_Glass_Jar = registerBlock("jungle_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Acacia_Wood_Glass_Jar = registerBlock("acacia_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Acacia_Plank_Glass_Jar = registerBlock("acacia_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block DarkOak_Wood_Glass_Jar = registerBlock("dark_oak_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block DarkOak_Plank_Glass_Jar = registerBlock("dark_oak_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Mangrove_Wood_Glass_Jar = registerBlock("mangrove_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Mangrove_Plank_Glass_Jar = registerBlock("mangrove_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Bamboo_Wood_Glass_Jar = registerBlock("bamboo_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Bamboo_Plank_Glass_Jar = registerBlock("bamboo_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Cherry_Wood_Glass_Jar = registerBlock("cherry_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Cherry_Plank_Glass_Jar = registerBlock("cherry_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Crimson_Wood_Glass_Jar = registerBlock("crimson_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Crimson_Plank_Glass_Jar = registerBlock("crimson_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Warped_Wood_Glass_Jar = registerBlock("warped_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block Warped_Plank_Glass_Jar = registerBlock("warped_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block PaleOak_Wood_Glass_Jar = registerBlock("pale_oak_wood_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
    public static final Block PaleOak_Plank_Glass_Jar = registerBlock("pale_oak_plank_glass_jar", GlassJarBlock::new, (AbstractBlock.Settings.copy(Blocks.GLASS).instrument(NoteBlockInstrument.HAT).sounds(BlockSoundGroup.GLASS).strength(0.5F, 1.0F).nonOpaque()));
