...
public class BookDeskBlockEntityRenderer implements BlockEntityRenderer<BookDeskBlockEntity, LecternRenderState> {
    ...
    @Override
    public void extractRenderState(BookDeskBlockEntity bookDeskBlockEntity, LecternRenderState lecternBlockEntityRenderState, float f, Vec3 vec3d, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlayCommand) {
